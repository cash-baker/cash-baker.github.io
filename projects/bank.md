...
(2) Programming a seperate Bank.java file that sorted, added and removed customers 
(3) Created a BCException.java file for handling exceptions when manipulating BankCustomer objects
